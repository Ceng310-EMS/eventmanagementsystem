...
<div id="container">
  <div id="header">
    ...
    <div id="menu">
      <ul>
        ...
        <li><a href="home.php">Kullanıcı Adı</a></li>
      </ul>
    </div>
  </div>
  ...
  <div id="panel">
	<div id="ceventpanel">
        ...
        <?php echo '<input type="text" class="span7" value="'. $title.'" required="required" />';?>
        ...
        <input type="datetime-local" name="endDate" id="endDate" required="required"/><br/>
